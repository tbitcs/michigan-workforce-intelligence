...
| HUD / Michigan Campaign to End Homelessness | Short attributed homelessness report findings; no bulk dataset ingested | Cite the specific report and its PIT/HMIS period and coverage; no agency endorsement or redistribution of full publications. |
| EIA | Candidate energy data | Catalog only until endpoint credentials and current terms are configured/reviewed. |
