...
License original report content under CC BY 4.0 and preserve source-specific terms, source attribution and adaptation notices. The software is MIT. Do not relicense public-domain facts, external graphics, source records or confidential data under the project grant; follow LICENSING.md and THIRD_PARTY_NOTICES.md.
